...
namespace Tests
{
    ...
    public class Test1_4
    {
        ...
        public void InvalidInputsTest()
        {
            ...
            TestHelpers.AssertExceptionThrown(() => { Question1_4.ReplaceSpaces(str, -1); }, typeof(ArgumentOutOfRangeException));

            // Null input string
            str = null;
            TestHelpers.AssertExceptionThrown(() => { Question1_4.ReplaceSpaces(str, 0); }, typeof(ArgumentNullException));
        }
        ...
        private static void ValideResult(string input, string expectedResult, int? inputLength = null)
        {
            ...
            Question1_4.ReplaceSpaces(str, length);
